...
class ModulesHelper
{
    ...
    {
        $modules = $this->database->fetchAll('SELECT id, title, module, position, ordering, params FROM @modules WHERE client_id = 0 AND published != -2 ORDER BY position, ordering');
